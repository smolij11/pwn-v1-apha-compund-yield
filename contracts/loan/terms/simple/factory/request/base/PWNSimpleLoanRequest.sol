...
import "contracts/nonce/PWNRevokedNonce.sol";
import "contracts/PWNErrors.sol";

abstract contract PWNSimpleLoanRequest is
    ...
    PWNHubAccessControl
{
    ...
    function _makeRequest(
        bytes32 requestStructHash,
        address borrower
    ) internal {
        // Check that caller is a borrower
        if (msg.sender != borrower) revert CallerIsNotStatedBorrower(borrower);
